<div class="container mx-auto flex">
    <div class="md:w-1/2">
        <img src="{{ asset('uploads/posts') . '/' . $post->imagen_id }}" alt="Imagen del post {{ $post->titulo }}">
        ...
        {{-- <div class="shadow bg-white p-5 mb-5">
            ...
            <form action="{{ route('comentario.store', ['post' => $post, 'user' => $user]) }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <textarea id="comentario" name="comentario" type="text" placeholder="Escribe tu comentario" class="border p-3 w-full rounded-lg @error('comentario')
                                    border-red-500 
