            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ route('popular') }}"
                        class="text-lime-700 hover:text-lime-900 ml-1 md:ml-2 text-sm font-medium dark:text-lime-400 dark:hover:text-lime-500">Pupulares</a>
                </div>
            </li>
        </ol>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden w-full shadow-sm sm:rounded-lg">
                <div class=" text-lime-900 dark:text-lime-500">
                    <div class="md:flex md:justify-center p-5">
                        <livewire:popular-posts :post="$post" />
                    </div>
                </div>
            </div>
        </div>
