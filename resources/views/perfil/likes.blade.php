<x-app-layout>
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="#"
                        class="text-lime-700 hover:text-lime-900 ml-1 md:ml-2 text-sm font-medium dark:text-lime-400 dark:hover:text-lime-500">Perfil</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
    ...
    <div class="flex justify-center">
        <div class="h-full w-full bg-gray-600 p-4">
            <div class="bg-gray-900 rounded-lg shadow-xl pb-8">
                <div x-data="{ openSettings: false }" class="absolute right-12 mt-4 rounded">
                    <button @click="openSettings = !openSettings"
                        class="border border-gray-400 p-2 rounded text-gray-300 hover:text-lime-300 bg-gray-100 bg-opacity-10 hover:bg-opacity-20"
                        title="Settings">
                    ...
                    <div x-show="openSettings" @click.away="openSettings = false"
                        class="bg-gray-900 absolute right-0 w-40 py-2 mt-1 border border-gray-200 shadow-2xl"
                        style="display: none;">
                        ...
                        <div class="py-2">
                            ...
                            <button class="w-full flex items-center py-1.5 px-6 space-x-2 hover:bg-lime-500">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-400" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="flex flex-col items-center -mt-20">
                    @if ($user->imagen)
                    <img class="w-40 border-4 border-white rounded-full"
                        src="{{ asset('perfiles') . '/' . $user->imagen }}"
                        alt="Imagen del usuario {{ $user->username }}">
                    @else
                    <img class="w-40 border-4 border-white rounded-full"
                        src="{{ asset('perfiles') . '/' . 'user.jpg' }}" alt="Imagen del usuario {{ $user->username }}">
                    @endif
                    <div class="flex items-center space-x-2 mt-2 text-lime-400">
            ...
            <div class="my-4 flex flex-col 2xl:flex-row space-y-4 2xl:space-y-0 2xl:space-x-4">
                    ...
                    <div class="flex-1 bg-white rounded-lg shadow-xl mt-4 p-8">
                        ...
                        <div class="relative px-4">
                            ...
                            <div class="flex items-center w-full my-6 -ml-1.5">
                                ...
                                <div class="w-11/12">
                                    <p class="text-sm">
                                        Message received from <a href="#" class="text-blue-600 font-bold">Cecilia
                                            Hendric</a>.</p>
                ...
                <div class="flex flex-col w-full">
                    <div class="flex-1 bg-gray-900 rounded-lg shadow-xl p-8">
                        <h4 class="text-xl text-gray-600 font-bold">Estado:</h4>
                        <p class="mt-2 text-gray-700">Hola, soy mienbro de OfertasJB y disfruto de las ofertas y las
                            compras!</p>
                    </div>
                    <div class="flex-1 bg-gray-900 rounded-lg shadow-xl mt-4 p-8">
                        <h4 class="text-xl text-gray-600 font-bold">Actividad</h4>

                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-4">
                            <div class="px-6 py-6 bg-gray-800 border border-gray-600 rounded-lg shadow-xl">
                                <div class="flex items-center justify-between">
                                    <span class="font-bold text-sm text-green-600">Post</span>
                                    <span
                                        class="text-xs bg-gray-200 hover:bg-gray-500 text-gray-500 hover:text-gray-200 px-2 py-1 rounded-lg transition duration-200 cursor-default"><a
                                            href="{{ route('index', $user->username) }}">Ver</a></span>
                                ...
                                <div class="flex items-center justify-between mt-6">
                                    ...
                                    <div class="flex flex-col">
                                        <div class="flex items-end">
                                            <span class="text-lime-500 text-2xl 2xl:text-3xl font-bold">{{
                                                $user->posts->count()
                                                }}</span>
                            ...
                            <div class="px-6 py-6 bg-gray-800 border border-gray-500 rounded-lg shadow-xl">
                                <div class="flex items-center justify-between">
                                    <span class="font-bold text-sm text-red-600">Me Encanta</span>
                                    {{-- <span
                                        class="text-xs bg-gray-200 hover:bg-gray-500 text-gray-500 hover:text-gray-200 px-2 py-1 rounded-lg transition duration-200 cursor-default">Ver</span>
                                    --}}
                                </div>
                                <div class="flex items-center justify-between mt-6">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        strokeWidth={1.5} stroke="currentColor"
                                        class="w-12 h-12 p-2.5 bg-red-400 bg-opacity-20 rounded-full text-red-600 border border-red-600">
                            ...
                            <div class="px-6 py-6 bg-gray-800 border border-gray-600 rounded-lg shadow-xl">
                                <div class="flex items-center justify-between">
                                    <span class="font-bold text-sm text-yellow-600">Guardado</span>
                                    {{-- <span
                                        class="text-xs bg-gray-200 hover:bg-gray-500 text-gray-500 hover:text-gray-200 px-2 py-1 rounded-lg transition duration-200 cursor-default">Ver</span>
                                    --}}
                                </div>
                                <div class="flex items-center justify-between mt-6">
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor"
                                            class="w-12 h-12 p-2.5 bg-yellow-400 bg-opacity-20 rounded-full text-yellow-600 border border-yellow-600">
                                            <path stroke-linecap="round" stroke-linejoin="round"
